...
public class LoginControllerTest {
	...
	//Eメールがない パスワードが正しい　Login 失敗　login.html 移動
	@Test
	public void testLongin_EmptyEmailCorrectPassword_File() throws Exception{
		//HTMLリクエストの送信を模擬（もぎ）する
		RequestBuilder request = MockMvcRequestBuilders
				.post("/login/process")
				.param("email", "")
	...
	//Eメールが正しい パスワードがない　Login 失敗　login.html 移動
	@Test
	public void testLongin_CorrectEmailEmptyPassword_File() throws Exception{
		//HTMLリクエストの送信を模擬（もぎ）する
		RequestBuilder request = MockMvcRequestBuilders
				.post("/login/process")
				.param("email", "test@test.com")
	...
	//Eメールがない パスワードがない　Login 失敗　login.html 移動
	@Test
	public void testLongin_EmptyEmailEmptyPassword_File() throws Exception{
		//HTMLリクエストの送信を模擬（もぎ）する
		RequestBuilder request = MockMvcRequestBuilders
				.post("/login/process")
				.param("email", "")
	...
	//Eメールが間違って パスワードが間違って　Login 失敗　login.html 移動
	@Test
	public void testLongin_WrongEmailWrongPassword_File() throws Exception{
		//HTMLリクエストの送信を模擬（もぎ）する
		RequestBuilder request = MockMvcRequestBuilders
				.post("/login/process")
				.param("email", "teet@test.com")
